      ...
      >
        <Grid item md={5}>
          <Container className={classes.intro_tab_checkbox}>
            ...
            <Typography className={classes.text}>Reasons</Typography>
          </Container>
        </Grid>
        <Grid item md={5}>
          <Container className={classes.intro_tab}>
            <Typography className={classes.text}>Impact</Typography>
          </Container>
        </Grid>
        <Grid item md={2} className={classes.no_border}>
          <Container className={classes.intro_tab}>
            <Typography className={classes.text}>Percentage</Typography>
          </Container>
        </Grid>
      </Grid>
    </Grid>
